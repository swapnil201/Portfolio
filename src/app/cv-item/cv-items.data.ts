...
export const CVITEMS: CvItem[] = [
  ...
  },
  {
    ...
    description:
      'Maintaining an operating the platform running our e-commerce shop. ' +
  ...
  },
  {
    ...
    description:
      'Implementing features for the e-Commerce platform Intershop in order to customize it. ' +
  ...
  },
  {
    ...
    description:
      'Ensuring the quality and functionality of the web shop, ERP software and their interfaces. ' +
  ...
  },
  {
    ...
    description:
      'Selling merchandising for sport events and concerts. Responsibility over one of the sale points.',
    link: '',
...
export const CERTIFICATES: CvItem[] = [
  {
    ...
    description: '',
    link:
      'https://www.certmetrics.com/amazon/public/badge.aspx?i=9&t=c&d=2018-11-26&ci=AWS00520066',
  ...
  },
  {
    ...
    description:
      'Overview (IS7-100), Intershop Frontend Development (IS7-114), Intershop Backend Programming (IS7-118)',
...
export const PROJECTS: CvItem[] = [
  {
    title: 'RatS',
    subtitle:
      'Script for transfering personal movie ratings from one site to another',
    begin: '2017-02',
    end: '',
    description:
      'This Python project offers an easy way of synchronizing personal movie ratings from one site (e.g. IMDB) to another (e.g. Trakt). ' +
  ...
  },
  {
    ...
    description:
      'I participated in this hackathon together with three collegues. ' +
  ...
  },
  {
    title: 'OFM Helper',
    subtitle:
      'Support for analysis of data in football management browser game \'OFM\'',
    begin: '2016-05',
    end: '2017-05',
    description:
      'OFM is a browser game where you manage a football team. ' +
  ...
  },
  {
    ...
    description:
      'GoOLAP is a fact search engine, which crawls the web and combines relevant data using natural language processing. ' +
  ...
  },
  {
    ...
    description:
      'The GPM is a global program for monitoring specific plants and analysing their behavior in the context of weather data. ' +
...
export const VOLUNTEERING: CvItem[] = [
  {
    ...
    subtitle:
      'Admission, visitor services, VIP support, stand-by man, special tasks',
    begin: '2007',
    end: '2016',
    description:
      'Admission, visitor services, VIP support, stand-by man, special tasks',
  ...
  },
  {
    ...
    description:
      'Technical setup, visitor service, security, special tasks, teardown',
  ...
  },
  {
    ...
    description:
      'Taking care of young rowers in training camps, recreational rowing tours, camp for visiting the Olympic Games 2012.',
  ...
  },
  {
    ...
    description:
      'Guiding visitors of home matches in the olympic stadium in Berlin. Lastly, as team lead.',
...
export const TALKS: CvItem[] = [
  ...
  },
  {
    ...
    description:
      'The discussion about DevOps is often focusing solely on the tooling aspect: automation, ' +
